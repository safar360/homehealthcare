...
- Frontend: React + TypeScript + Vite web apps (patient app and operations portal), responsive for mobile browsers. A Flutter client was trialled and dropped; see architecture.md.
- Backend: Supabase
- Database: PostgreSQL
- Auth: Supabase Auth
